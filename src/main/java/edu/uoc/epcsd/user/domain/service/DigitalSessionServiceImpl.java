...
public class DigitalSessionServiceImpl implements DigitalSessionService {   
	...
	public Long updateDigitalSession(Long digitalSessionId, String description, String link, String location, Long userId) {
        ...
        DigitalSession digitalSession = digitalSessionRepository.findDigitalSessionById(digitalSessionId).orElseThrow(IllegalArgumentException::new);
	...
	public void dropDigitalSession(Long id) {
		DigitalSession digitalSession = digitalSessionRepository.findDigitalSessionById(id).orElseThrow(IllegalArgumentException::new);
				
        digitalSessionRepository.dropDigitalSession(digitalSession);		
	}
